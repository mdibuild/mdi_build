  ...
  Future<void> save() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Projet enregistrÃƒÆ’Ã‚Â©.')),
      );
      Navigator.of(context).pop();
    } catch (error, stackTrace) {
      debugPrint('Erreur crÃƒÆ’Ã‚Â©ation projet: $error');
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Erreur crÃƒÆ’Ã‚Â©ation projet: $error')),
      );
    } finally {
      if (mounted) {
