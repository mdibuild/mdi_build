...
class _AchatsPageState extends ConsumerState<AchatsPage> {
  ...
  Future<void> _changeStatus(
    ...
    if (context.mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content:
                Text('Statut mis ÃƒÆ’Ã‚Â  jour : ${_statusLabel(status)}')),
      );
    }
  }
  ...
  Future<void> _deletePurchase(
    ...
    if (context.mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Achat supprimÃƒÆ’Ã‚Â©.')),
      );
    }
  }
          ...
          child: Column(
            children: [
              AppScaffoldTitle(
                title: 'Achats',
                subtitle:
                    'Achats libres ou reliÃƒÆ’Ã‚Â©s au quantitatif et au devis.',
                      ...
                      SizedBox(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          items: const [
                            ...
                            DropdownMenuItem(
                                value: 'dg_valide',
                                child: Text('DG validÃƒÆ’Ã‚Â©')),
                            DropdownMenuItem(
                                value: 'commande',
                                child: Text('CommandÃƒÆ’Ã‚Â©')),
                            DropdownMenuItem(
                                value: 'livre', child: Text('LivrÃƒÆ’Ã‚Â©')),
                            DropdownMenuItem(
                                value: 'annule', child: Text('AnnulÃƒÆ’Ã‚Â©')),
                            DropdownMenuItem(
                                value: 'archive',
                                child: Text('ArchivÃƒÆ’Ã‚Â©')),
                          ],
                          onChanged: (value) {
                            if (value != null) {
                ...
                children: [
                  ...
                  if (purchase.status == 'brouillon')
                    FilledButton.icon(
                      ...
                      label: const Text('DG validÃƒÆ’Ã‚Â©'),
                    ),
            ...
            const Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 2),
                  Text('Montant cumulÃƒÆ’Ã‚Â© des lignes'),
                ],
              ),
            ),
            Text(
...
String _statusLabel(String status) {
  switch (status) {
    case 'brouillon':
      return 'Brouillon';
    case 'dg_valide':
      return 'DG validÃƒÆ’Ã‚Â©';
    case 'commande':
      return 'CommandÃƒÆ’Ã‚Â©';
    case 'livre':
      return 'LivrÃƒÆ’Ã‚Â©';
    case 'annule':
      return 'AnnulÃƒÆ’Ã‚Â©';
