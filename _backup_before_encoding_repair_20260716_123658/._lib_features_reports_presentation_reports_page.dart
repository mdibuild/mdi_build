...
String _statusLabel(String value) {
  switch (value) {
    case 'draft':
      return 'Brouillon';
    case 'generated':
      return 'GÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©rÃƒÆ’Ã‚Â©';
    case 'finalized':
      return 'FinalisÃƒÆ’Ã‚Â©';
    default:
      return value;
  }
}
...
String _periodLabel(String value) {
  switch (value) {
    ...
    case 'previous_week':
      return 'Semaine prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dente';
    case 'current_month':
      return 'Mois en cours';
    case 'custom':
      return 'PersonnalisÃƒÆ’Ã‚Â©e';
    default:
      return value;
  }
}
...
String _reportPeriodText(ProjectReport report) {
  ...
  return '${_dateLabel(report.periodStart!)} ÃƒÂ¢Ã¢DAÂ Ã¢DAâ„¢ ${_dateLabel(report.periodEnd!)}';
}
...
class _ReportsPageState extends ConsumerState<ReportsPage> {
  ...
  String _formatRange(DateTimeRange range) {
    return '${_dateLabel(range.start)} ÃƒÂ¢Ã¢DAÂ Ã¢DAâ„¢ ${_dateLabel(range.end)}';
  }
  ...
  Future<void> _runAutomaticGeneration({
    ...
    if (_selectedPeriod == 'custom' && _customRange == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('Choisis une pÃƒÆ’Ã‚Â©riode personnalisÃƒÆ’Ã‚Â©e.')),
      );
      return;
    }
    ...
    try {
      ...
      if (createOnly) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Rapport gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©rÃƒÆ’Ã‚Â© : ${report.title}')),
        );
        return;
      }
      ...
      if (_selectedFormat == 'pdf') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content:
                  Text('PDF gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©rÃƒÆ’Ã‚Â© : ${report.title}')),
        );
        return;
      }
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text('Excel gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©rÃƒÆ’Ã‚Â© : $filePath')),
      );
    } catch (error) {
      if (!mounted) {
        return;
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text('Erreur gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©ration/export : $error')),
      );
    } finally {
      if (mounted) {
        setState(() {
  ...
  Future<void> _exportExistingReport({
    ...
    try {
      ...
      if (format == 'pdf') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('PDF exportÃƒÆ’Ã‚Â© : ${report.title}')),
        );
        return;
      }
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Excel exportÃƒÆ’Ã‚Â© : $filePath')),
      );
    } catch (error) {
      if (!mounted) {
        return;
  ...
  Future<void> _deleteReport(ProjectReport report) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Rapport supprimÃƒÆ’Ã‚Â©.')),
    );
  }
      ...
      children: [
          ...
          child: Column(
            ...
            children: [
              const PremiumSectionHeader(
                title: 'Vue pilotage',
                subtitle:
                    'SynthÃƒÆ’Ã‚Â¨se haute lisibilitÃƒÆ’Ã‚Â© pour chef de projet',
              ),
              const SizedBox(height: 16),
              Wrap(
                spacing: 12,
              ...
              Container(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    Text('PÃƒÆ’Ã‚Â©riode : ${_periodLabel(_selectedPeriod)}'),
        ...
        PremiumSurfaceCard(
          child: Column(
            ...
            children: [
              const PremiumSectionHeader(
                title: 'GÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©ration automatique',
                subtitle:
                    'CrÃƒÆ’Ã‚Â©er, gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©rer ou exporter depuis un seul centre',
              ),
              const SizedBox(height: 16),
              DropdownButtonFormField<String>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(
                      value: 'metrage', child: Text('MÃƒÆ’Ã‚Â©trÃƒÆ’Ã‚Â©')),
                ],
                onChanged: (value) {
                  if (value != null) {
              ...
              DropdownButtonFormField<String>(
                ...
                decoration: const InputDecoration(labelText: 'PÃƒÆ’Ã‚Â©riode'),
                items: const [
                  DropdownMenuItem(
                    value: 'current_week',
                  ...
                  DropdownMenuItem(
                    value: 'previous_week',
                    child: Text('Semaine prÃƒÆ’Ã‚Â©cÃƒÆ’Ã‚Â©dente'),
                  ),
                  DropdownMenuItem(
                    value: 'current_month',
                  ...
                  DropdownMenuItem(
                    value: 'custom',
                    child: Text('PersonnalisÃƒÆ’Ã‚Â©e'),
                  ),
                ],
                onChanged: (value) {
                  if (value != null) {
              ...
              PremiumActionRow(
                children: [
                  FilledButton.icon(
                    ...
                    label: Text(
                      _generating
                          ? 'GÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©ration...'
                          : 'CrÃƒÆ’Ã‚Â©er le rapport',
                    ),
                  ),
                  ElevatedButton.icon(
                    onPressed:
                    ...
                    label: Text(
                      _generating
                          ? 'Traitement...'
                          : 'GÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©rer ${_formatLabel(_selectedFormat)}',
                    ),
                  ),
                ],
              ),
          ...
          child: Column(
            ...
            children: [
              const PremiumSectionHeader(
                title: 'Historique',
                subtitle:
                    'Recherche et lecture des rapports dÃƒÆ’Ã‚Â©jÃƒÆ’Ã‚Â  produits',
              ),
      ...
      child: Column(
        ...
        children: [
          ...
          if (report.periodStart != null && report.periodEnd != null) ...[
            ...
            Text(
              'PÃƒÆ’Ã‚Â©riode : ${_reportPeriodText(report)}',
          ...
          const SizedBox(height: 12),
          PremiumInfoLine(label: 'DÃƒÆ’Ã‚Â©cisions', value: report.decisions),
          const SizedBox(height: 12),
          PremiumInfoLine(
              label: 'Prochaines ÃƒÆ’Ã‚Â©tapes', value: report.nextSteps),
          const SizedBox(height: 12),
          Text(
            'CrÃƒÆ’Ã‚Â©ÃƒÆ’Ã‚Â© le ${_dateTimeLabel(report.createdAt)}',
            style: Theme.of(context).textTheme.bodyMedium,
          ),
          const SizedBox(height: 16),
          PremiumActionRow(
            children: [
              ...
              OutlinedButton.icon(
                ...
                label:
                    Text(report.isArchived ? 'DÃƒÆ’Ã‚Â©sarchiver' : 'Archiver'),
              ),
              OutlinedButton.icon(
                onPressed: onDelete,
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  decoration:
                      const InputDecoration(labelText: 'MÃƒÆ’Ã‚Â©tÃƒÆ’Ã‚Â©o'),
                ),
                const SizedBox(height: 12),
                TextFormField(
                ...
                TextFormField(
                  ...
                  maxLines: 4,
                  decoration:
                      const InputDecoration(labelText: 'DÃƒÆ’Ã‚Â©cisions'),
                ),
                const SizedBox(height: 12),
                TextFormField(
                  ...
                  maxLines: 4,
                  decoration: const InputDecoration(
                      labelText: 'Prochaines ÃƒÆ’Ã‚Â©tapes'),
                ),
              ],
            ),
          ),
