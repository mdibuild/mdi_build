...
class _DocumentFormDialogState extends ConsumerState<DocumentFormDialog> {
  ...
  Future<void> pickFile() async {
    ...
    if (file.bytes == null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text(
                'Impossible de lire le fichier sÃƒÆ’Ã‚Â©lectionnÃƒÆ’Ã‚Â©.')),
      );
      return;
    }
  ...
  Future<void> save() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Document enregistrÃƒÆ’Ã‚Â©.')),
      );
    } catch (error) {
                          ...
                          children: [
                            Expanded(
                              child: selectedFile == null
                                  ? const Text(
                                      'Aucun fichier sÃƒÆ’Ã‚Â©lectionnÃƒÆ’Ã‚Â©.')
                                  : Column(
                                      crossAxisAlignment:
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                            'TÃƒÆ’Ã‚Â¢che : ${(widget.taskId ?? '').isEmpty ? '-' : widget.taskId!}'),
