    ...
    if (startDate != null && endDate != null && endDate.isBefore(startDate)) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content:
                Text('La fin prévue ne peut pas être avant le début prévu.'),
          ),
        );
      }
      return;
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            isEditing
                ? 'Tâche enregistrée.'
                : 'Tâche créée. Tu pourras ajouter des documents en la rouvrant.',
          ),
        ),
      );
          ...
          children: [
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: const [
                        ...
                        DropdownMenuItem(
                            value: 'bloquee', child: Text('Bloquée')),
                        DropdownMenuItem(
                            value: 'terminee', child: Text('Terminée')),
                        DropdownMenuItem(
                            value: 'annulee', child: Text('Annulée')),
                        DropdownMenuItem(
                            value: 'archivee', child: Text('Archivée')),
                      ],
                      onChanged: (value) {
                        if (value != null) {
                ...
                child: Column(
                  children: [
                    ...
                    TextField(
                      ...
                      readOnly: true,
                      decoration: const InputDecoration(
                        labelText: 'Durée prévue (jours)',
                        prefixIcon: Icon(Icons.timelapse_outlined),
                        helperText: 'Calcul automatique selon début et fin',
                      ),
                    ),
                    const SizedBox(height: 12),
                    TextField(
            ...
            Card(
              child: SwitchListTile(
                ...
                subtitle: const Text('Masquer la tâche des éléments actifs'),
                secondary: Icon(
                  isArchived
...
class _TypeChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Chip(
      label: Text(isMilestone ? 'Jalon' : 'Tâche'),
      avatar: Icon(
