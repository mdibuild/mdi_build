...
class PlanningNotificationsService {
  ...
  Future<void> notifyForTasks({
    ...
    for (final task in datedTasks) {
      ...
      if (overdue) {
        title = 'TÃƒÆ’Ã‚Â¢che en retard';
        body =
            '$projectName ÃƒÂ¢DAÃ‚Â¢ ${task.title} devait finir le ${_frDate(plannedEnd)}';
        type = 'overdue';
      } else if (dueToday) {
        title = 'ÃƒÆ’Ã¢DAÂ°chÃƒÆ’Ã‚Â©ance aujourdÃƒÂ¢DAÃ¢âDAžÂ¢hui';
        body =
            '$projectName ÃƒÂ¢DAÃ‚Â¢ ${task.title} finit aujourdÃƒÂ¢DAÃ¢âDAžÂ¢hui';
        type = 'due_today';
      } else if (startToday) {
        title = 'DÃƒÆ’Ã‚Â©marrage aujourdÃƒÂ¢DAÃ¢âDAžÂ¢hui';
        body =
            '$projectName ÃƒÂ¢DAÃ‚Â¢ ${task.title} commence aujourdÃƒÂ¢DAÃ¢âDAžÂ¢hui';
        type = 'start_today';
      } else if (dueSoon) {
        title = 'ÃƒÆ’Ã¢DAÂ°chÃƒÆ’Ã‚Â©ance proche';
        body =
            '$projectName ÃƒÂ¢DAÃ‚Â¢ ${task.title} finit le ${_frDate(plannedEnd)}';
        type = 'due_soon';
      }
      ...
      await _plugin.show(
        ...
        const NotificationDetails(
          android: AndroidNotificationDetails(
            ...
            'Planning deadlines',
            channelDescription:
                'Notifications de rappel des ÃƒÆ’Ã‚Â©chÃƒÆ’Ã‚Â©ances du planning',
