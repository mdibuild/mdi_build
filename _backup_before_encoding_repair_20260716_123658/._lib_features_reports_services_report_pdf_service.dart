...
class ReportPdfService {
  ...
  pw.Widget _buildMeta(ProjectReport report) {
    return pw.Container(
      ...
      child: pw.Column(
        crossAxisAlignment: pw.CrossAxisAlignment.start,
        children: [
          pw.Text('MÃƒÂ©tÃƒÂ©o : ${_safeValue(report.weather)}'),
          pw.SizedBox(height: 4),
          pw.Text('CrÃƒÂ©ÃƒÂ© le : ${_formatDateTime(report.createdAt)}'),
          pw.SizedBox(height: 4),
          pw.Text('Mis ÃƒÂ  jour le : ${_formatDateTime(report.updatedAt)}'),
        ],
      ),
    );
  }
  ...
  pw.Widget _buildFooter() {
    return pw.Container(
      ...
      child: pw.Text(
        'Rapport gÃƒÂ©nÃƒÂ©rÃƒÂ© depuis le module Rapports.',
