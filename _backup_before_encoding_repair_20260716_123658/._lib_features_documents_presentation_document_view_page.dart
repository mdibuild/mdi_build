...
class _DocumentViewPageState extends ConsumerState<DocumentViewPage> {
  ...
  Future<void> _openInApp(String signedUrl) async {
    ...
    if (!launched && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('Impossible dÃƒÂ¢DAÃ¢âDAžÂ¢ouvrir le document.')),
      );
    }
  }
                ...
                child: Wrap(
                  ...
                  children: [
                    FilledButton.icon(
                      ...
                      label: Text(document.isImage
                          ? 'RafraÃƒÆ’Ã‚Â®chir / ouvrir'
                          : 'Ouvrir'),
                    ),
                    OutlinedButton.icon(
  ...
  Widget _buildContent({
          ...
          child: Image.network(
            ...
            errorBuilder: (_, __, ___) {
              return const Padding(
                ...
                child: Text('Impossible dÃƒÂ¢DAÃ¢âDAžÂ¢afficher cette image.'),
              );
            },
    ...
    if (document.isPdf) {
      return _DocumentFallbackView(
        ...
        title: 'PDF dÃƒÆ’Ã‚Â©tectÃƒÆ’Ã‚Â©',
        subtitle:
            'Le PDF sÃƒÂ¢DAÃ¢âDAžÂ¢ouvre dans la vue intÃƒÆ’Ã‚Â©grÃƒÆ’Ã‚Â©e du tÃƒÆ’Ã‚Â©lÃƒÆ’Ã‚Â©phone.',
    ...
    return _DocumentFallbackView(
      ...
      subtitle:
          'Ce type de fichier sÃƒÂ¢DAÃ¢âDAžÂ¢ouvre via le navigateur intÃƒÆ’Ã‚Â©grÃƒÆ’Ã‚Â© ou une application externe.',
      onOpen: () => _openInApp(signedUrl),
    );
  }
}
