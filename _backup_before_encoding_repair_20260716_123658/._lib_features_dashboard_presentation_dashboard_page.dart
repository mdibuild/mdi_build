        ...
        data: (metrics) => projectAsync.when(
          data: (project) {
            final subtitle = project == null
                ? 'Pilotage global de lÃƒÂ¢DAÃ¢âDAžÂ¢activitÃƒÆ’Ã‚Â©'
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      const PremiumSectionHeader(
                        title: 'Vue exÃƒÆ’Ã‚Â©cutive',
                        subtitle:
                            'Chiffres clÃƒÆ’Ã‚Â©s et signaux ÃƒÆ’Ã‚Â  surveiller',
                      ),
                      const SizedBox(height: 16),
                      Wrap(
                        spacing: 12,
                ...
                PremiumSurfaceCard(
                  child: Column(
                    ...
                    children: [
                      const PremiumSectionHeader(
                        title: 'Pilotage opÃƒÆ’Ã‚Â©rationnel',
                        subtitle: 'Suivi simple pour chef de projet',
                      ),
                      const SizedBox(height: 18),
                      _StatusRow(
                        icon: Icons.check_circle_outline,
                        label: 'TÃƒÆ’Ã‚Â¢ches terminÃƒÆ’Ã‚Â©es',
                ...
                PremiumSurfaceCard(
                  child: Column(
                    ...
                    children: [
                      const PremiumSectionHeader(
                        title: 'AccÃƒÆ’Ã‚Â¨s rapide',
                        subtitle: 'Parcours mÃƒÆ’Ã‚Â©tier prioritaire',
                      ),
                      const SizedBox(height: 16),
                      PremiumActionRow(
                        children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      const PremiumSectionHeader(
                        ...
                        subtitle: 'Lecture rapide des signaux mÃƒÆ’Ã‚Â©tier',
                      ),
                ...
                PremiumSurfaceCard(
                  child: Column(
                    ...
                    children: [
                      const PremiumSectionHeader(
                        title: 'Rapports rÃƒÆ’Ã‚Â©cents',
                        subtitle:
                            'Production rÃƒÆ’Ã‚Â©cente et suivi direction',
                      ),
                      const SizedBox(height: 14),
                      if (metrics.recentReportTitles.isEmpty)
                        const Text('Aucun rapport rÃƒÆ’Ã‚Â©cent.')
                      else
