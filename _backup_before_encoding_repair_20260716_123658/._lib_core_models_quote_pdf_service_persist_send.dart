...
class QuotePdfService {
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          _buildSignature(signatureBytes),
          pw.SizedBox(height: 24),
          _buildFooter(),
        ],
      ),
    ...
    return pw.Table(
      ...
      children: [
        pw.TableRow(
          ...
          children: [
            _cell('DÃƒÆ’Ã‚Â©signation', bold: true),
            _cell('QtÃƒÆ’Ã‚Â©', bold: true),
            _cell('UnitÃƒÆ’Ã‚Â©', bold: true),
            _cell('PU', bold: true),
  ...
  pw.Widget _buildSignature(Uint8List? signatureBytes) {
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          if (signatureBytes == null)
            pw.Text('Aucune signature enregistrÃƒÆ’Ã‚Â©e.')
          else
            pw.Image(
  ...
  pw.Widget _buildFooter() {
    return pw.Container(
      ...
      child: pw.Text(
        'Document gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©rÃƒÆ’Ã‚Â© depuis le module Devis.',
