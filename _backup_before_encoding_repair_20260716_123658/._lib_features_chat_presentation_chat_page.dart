...
class _ChatPageState extends ConsumerState<ChatPage> {
  ...
  Future<void> _toggleRecord() async {
    ...
    if (!allowed) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Microphone non autorisÃƒÂ©.')),
      );
      return;
    }
  ...
  Future<void> _sendAttachment({
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Erreur piÃƒÂ¨ce jointe : $error')),
      );
    } finally {
      if (mounted) {
        setState(() {
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        tooltip: _recording ? 'ArrÃƒÂªter audio' : 'Audio',
