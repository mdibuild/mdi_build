...
class TaskDocumentsSection extends ConsumerWidget {
  ...
  Future<void> _openUploadDialog(BuildContext context, WidgetRef ref) async {
    final created = await showDialog<bool>(
      context: context,
      builder: (_) => DocumentFormDialog(taskId: taskId),
    );
  ...
  Future<void> _toggleArchive(
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          document.isArchived
              ? 'Document dÃƒÆ’Ã‚Â©sarchivÃƒÆ’Ã‚Â©.'
              : 'Document archivÃƒÆ’Ã‚Â©.',
        ),
      ),
    );
  }
          ...
          children: [
            Row(
              children: [
                Expanded(
                  child: Text(
                    'Documents liÃƒÆ’Ã‚Â©s ÃƒÆ’Ã‚Â  la tÃƒÆ’Ã‚Â¢che',
              ...
              data: (documents) {
                if (documents.isEmpty) {
                  return const Align(
                    ...
                    child: Text(
                        'Aucun document liÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â  cette tÃƒÆ’Ã‚Â¢che.'),
                  );
                }
...
class _TaskDocumentTile extends StatelessWidget {
  const _TaskDocumentTile({
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            _InfoLine(label: 'AjoutÃƒÆ’Ã‚Â©', value: createdAt),
            ...
            Wrap(
              ...
              children: [
                ...
                TextButton.icon(
                  ...
                  label: Text(
                      document.isArchived ? 'DÃƒÆ’Ã‚Â©sarchiver' : 'Archiver'),
                ),
                TextButton.icon(
                  onPressed: onDelete,
