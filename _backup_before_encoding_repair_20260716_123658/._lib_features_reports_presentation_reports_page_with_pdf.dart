      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            _InfoBlock(label: 'DÃƒÆ’Ã‚Â©cisions', value: report.decisions),
            const SizedBox(height: 8),
            _InfoBlock(
                label: 'Prochaines ÃƒÆ’Ã‚Â©tapes', value: report.nextSteps),
            const SizedBox(height: 8),
            Text(
              'CrÃƒÆ’Ã‚Â©ÃƒÆ’Ã‚Â© le $createdAt',
            ...
            Wrap(
              ...
              children: [
                ...
                TextButton.icon(
                  ...
                  label: Text(
                      report.isArchived ? 'DÃƒÆ’Ã‚Â©sarchiver' : 'Archiver'),
                ),
                TextButton.icon(
                  onPressed: onDelete,
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'MÃƒÆ’Ã‚Â©tÃƒÆ’Ã‚Â©o',
                    hintText:
                        'Ex. EnsoleillÃƒÆ’Ã‚Â©, pluie lÃƒÆ’Ã‚Â©gÃƒÆ’Ã‚Â¨re',
                  ),
                ),
                const SizedBox(height: 12),
                TextFormField(
