  ...
  Widget build(BuildContext context) {
    ...
    if (widget.tasks.isEmpty) {
      return const _EmptyGanttCard(
        text: 'Aucune tÃƒÆ’Ã‚Â¢che ÃƒÆ’Ã‚Â  afficher dans le Gantt.',
      );
    }

    if (datedTasks.isEmpty) {
      return const _EmptyGanttCard(
        text: 'Aucune tÃƒÆ’Ã‚Â¢che avec dates planifiÃƒÆ’Ã‚Â©es.',
      );
    }
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${task.progress.toStringAsFixed(0)}% ÃƒÂ¢DAÃ‚Â¢ ${_statusLabel(task.status)}',
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
