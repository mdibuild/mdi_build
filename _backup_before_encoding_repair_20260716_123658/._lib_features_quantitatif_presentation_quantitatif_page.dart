...
class QuantitatifPage extends ConsumerWidget {
  ...
  Future<void> _openGeneratePurchaseDialog(
    ...
    final purchaseItems = <PurchaseItem>[
      if (line.floorArea > 0)
        PurchaseItem(
          id: '',
          purchaseId: '',
          article: 'QuantitÃƒÆ’Ã‚Â© sol - ${line.spaceName}',
          description:
              'Surface sol ÃƒÆ’Ã‚Â  approvisionner depuis le quantitatif',
      ...
      if (line.ceilingArea > 0)
        PurchaseItem(
          id: '',
          purchaseId: '',
          article: 'QuantitÃƒÆ’Ã‚Â© plafond - ${line.spaceName}',
          description:
              'Surface plafond ÃƒÆ’Ã‚Â  approvisionner depuis le quantitatif',
      ...
      if (line.netWallArea > 0)
        PurchaseItem(
          id: '',
          purchaseId: '',
          article: 'QuantitÃƒÆ’Ã‚Â© murs nets - ${line.spaceName}',
          description:
              'Surface murs nets ÃƒÆ’Ã‚Â  approvisionner depuis le quantitatif',
    ...
    final draftPurchase = Purchase(
      ...
      projectId: projectId,
      title: 'Achat gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©rÃƒÆ’Ã‚Â© - ${line.spaceName}',
      lot: line.spaceType.toString(),
      notes:
          'GÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©rÃƒÆ’Ã‚Â© depuis le quantitatif de $projectName',
      status: 'brouillon',
    ...
    await showDialog<void>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          title:
              const Text('GÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©rer achat depuis le quantitatif'),
          content: SizedBox(
            width: 760,
            child: PurchaseForm(
              projectOptions: [
              ...
              onSubmit: (value) async {
                ...
                if (dialogContext.mounted) {
                  ScaffoldMessenger.of(dialogContext).showSnackBar(
                    const SnackBar(
                        content: Text(
                            'Achat gÃƒÆ’Ã‚Â©nÃƒÆ’Ã‚Â©rÃƒÆ’Ã‚Â© depuis le quantitatif.')),
                  );
                }
              },
            ),
                          ...
                          child: SizedBox(
                            ...
                            child: DataTable(
                              columns: const [
                                ...
                                DataColumn(
                                    label: Text('PÃƒÆ’Ã‚Â©rimÃƒÆ’Ã‚Â¨tre')),
