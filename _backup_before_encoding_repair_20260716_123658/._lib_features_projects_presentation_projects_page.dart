                ...
                children: [
                  PremiumHeroHeader(
                    ...
                    subtitle: currentProject == null
                        ? 'Vue globale de lÃƒÂ¢DAÃ¢âDAžÂ¢entreprise'
                        ...
                        PremiumActionRow(
                          children: [
                            ...
                            FilterChip(
                              ...
                              label: const Text('ArchivÃƒÆ’Ã‚Â©s'),
                              onSelected: (_) =>
                    ...
                    child: Column(
                      ...
                      children: [
                        PremiumSectionHeader(
                          title: 'Chantiers',
                          subtitle: '${filtered.length} rÃƒÆ’Ã‚Â©sultat(s)',
                        ),
                        const SizedBox(height: 16),
                        if (filtered.isEmpty)
                          const Padding(
                            ...
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 10),
                                  PremiumInfoLine(
                                    label: 'PÃƒÆ’Ã‚Â©riode',
                                    value:
                                        '$startDate ÃƒÂ¢Ã¢DAÂ Ã¢DAâ„¢ $endDate',
                                  ),
                                  const SizedBox(height: 14),
                                  ClipRRect(
                                  ...
                                  Text(
                                    '${(progress * 100).round()}% dÃƒÂ¢DAÃ¢âDAžÂ¢avancement',
                                    style:
